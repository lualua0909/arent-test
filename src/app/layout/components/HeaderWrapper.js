            ...
            <div className="w-full mx-auto h-full flex justify-between max-w-[960px]">
                ...
                <div className="grid grid-cols-4 gap-4">
                    <div className="flex content-center w-full items-center">
                        <img className="w-[32px] h-[32px`] mr-[8px]" src={iconMemo} alt={'meno'}/>
                        <span
                            className="mr-[24px] text-white flex content-center text-[16px] font-light leading-[23px]">自分の記録</span>
                    </div>
                    <div className="flex content-center w-full items-center">
                        <img className="w-[32px] h-[32px`] mr-[8px]" src={iconChallenge} alt={'meno'}/>
                        <span
                            className="text-white flex content-center text-[16px] font-light leading-[23px]">チャレンジ</span>
                    </div>
                    <div className="flex content-center w-full items-center">
                        <div title={count} className="count">
                            <img className="w-[32px] h-[32px`] mr-[8px] " src={iconInfo} alt={'meno'}/>
                        </div>
                        <span
                            className="text-white flex content-center text-[16px] font-light leading-[23px]">お知らせ</span>
                    </div>
                        ...
                        <Menu as="div" className="relative inline-block text-left">
                            <div>
                                <Menu.Button>
                                    {
                                        !showClose ? (
                                            <img onClick={() => setShowClose(true)} className="w-[32px] h-[32px`]"
                                                 src={iconMenu} alt={'meno'}/>
                                        ) : (
                                            <img onClick={() => setShowClose(false)} className="w-[32px] h-[32px`]" src={iconClose} alt={'meno'}/>
                                        )
                                    }
                                </Menu.Button>
                            </div>
